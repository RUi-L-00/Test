...
@protocol JMWebViewControllerDataSource <NSObject>
...
@interface JMWebViewController : JMBaseViewController<WKNavigationDelegate, WKUIDelegate, JMWebViewControllerDelegate, JMWebViewControllerDataSource>
